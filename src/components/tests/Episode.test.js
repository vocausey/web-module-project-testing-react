...
const testEpisode = {
    ...
    season: 1,
    number: 1,
    summary: "we are watching season 2",
    runtime: 1
}
...
test("renders the summury test passed as prop", ()=>{
    ...
    const summary = screen.queryByText(/we are watching season 2/i)
    expect (summary ).toBeInTheDocument(/we are watching season 2/i)
